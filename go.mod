...
require (
	github.com/decred/dcrd/blockchain/stake/v2 v2.0.1 // indirect
	github.com/decred/dcrd/chaincfg v1.5.1
	github.com/decred/dcrd/chaincfg/chainhash v1.0.2
	github.com/decred/dcrd/chaincfg/v2 v2.2.0 // indirect
	...
	github.com/decred/dcrwallet/rpc/jsonrpc/types v1.1.0 // indirect
